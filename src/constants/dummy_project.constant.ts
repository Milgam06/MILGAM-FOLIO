import { ETECH_STACK_LIST } from './techStack.constant';
...
export const DUMMY_PROJECT_CONSTANT: IProject[] = [
  {
    ...
    stack: [ETECH_STACK_LIST.MANTINE, ETECH_STACK_LIST.NEXT_JS],
  ...
  },
  {
    ...
    stack: [ETECH_STACK_LIST.NEXT_JS, ETECH_STACK_LIST.SUPABASE],
    result: 'Daily writing flow improved',
    planning: [
      '매일 짧게 기록할 수 있는 작성 흐름을 설계했습니다.',
      '개발 기록과 회고를 주제별로 탐색할 수 있도록 구성했습니다.',
    ],
    dev: [
      '작성 화면과 기록 목록을 분리해 화면 구성을 단순화했습니다.',
      '저장 상태와 오류 안내를 통해 작성 내용을 확인할 수 있도록 구성했습니다.',
    ],
  },
  {
    id: 'safe-route',
    ...
    stack: [ETECH_STACK_LIST.REACT, ETECH_STACK_LIST.TYPESCRIPT],
    result: 'Built quiz and progress UI',
    planning: [
      '보안 개념을 짧은 설명과 퀴즈로 나누어 학습 부담을 줄였습니다.',
      '학습 진행 상황을 확인하며 다음 실습으로 이동하도록 설계했습니다.',
    ],
    dev: [
      '퀴즈 선택과 결과 피드백을 재사용 가능한 UI로 구성했습니다.',
      'TypeScript로 학습 항목과 진행 상태의 데이터 구조를 정의했습니다.',
    ],
  },
  {
    id: 'milgamfolio-v1',
    ...
    stack: [ETECH_STACK_LIST.VITE, ETECH_STACK_LIST.REACT],
    result: 'Redesigned as cinematic portfolio',
    planning: [
      '이전 포트폴리오의 정보 구조와 탐색 경험을 돌아보았습니다.',
      '프로젝트의 결과와 작업 과정을 함께 전달하는 방향으로 개선점을 정리했습니다.',
    ],
    dev: [
      '섹션 단위로 화면을 분리해 콘텐츠를 관리했습니다.',
      '다양한 화면 크기에서 읽기 쉬운 레이아웃으로 개선했습니다.',
    ],
  },
];
